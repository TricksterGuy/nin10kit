...
Nin10KitGUI::Nin10KitGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText71 = new wxStaticText( m_panel2, wxID_ANY, _("Warning: Do not edit loaded images with another program. Delete the image before editing!"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText71->Wrap( -1 );
	bSizer5->Add( m_staticText71, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	
	panelSizer->Add( bSizer5, 0, wxALIGN_CENTER_HORIZONTAL, 0 );
	...
	wxString modeChoices[] = { _("GBA Mode 3 Bitmap"), _("GBA Mode 4 Bitmap with Palette"), _("GBA Mode 0 Map, Tileset, and Palette (8 Bpp)"), _("GBA Mode 0 Map, Tileset, and Palette Banks (4 Bpp)"), _("GBA Sprites with Palette for Tiled Modes (8 Bpp)"), _("GBA Sprites with Palette Banks for Tiled Modes (4 Bpp)"), _("GBA Sprites with Palette for Bitmap Modes (8 Bpp)"), _("GBA Sprites with Palette Banks for Bitmap Modes (4 Bpp)"), _("NDS Bitmap"), _("NDS Bitmap with Palette"), _("NDS Map, Tileset, and Palette (8 Bpp)"), _("NDS Map, Tileset, and Palette (4 Bpp)"), _("NDS Sprites with Palette (8 Bpp)"), _("NDS Sprites with Palette (4 Bpp)") };
	...
	panelSizer->Add( bSizer6, 0, wxEXPAND, 5 );
	...
	panelSizer->Add( 0, 0, 1, wxEXPAND, 5 );
	
	imageInfoPanel = new wxPanel( m_panel2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	imageInfoPanel->Hide();
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( imageInfoPanel, wxID_ANY, _("Image Info") ), wxVERTICAL );
	...
	bSizer91->Add( sbSizer1, 0, wxEXPAND, 8 );
	
	
	imageInfoPanel->SetSizer( bSizer91 );
	imageInfoPanel->Layout();
	bSizer91->Fit( imageInfoPanel );
	panelSizer->Add( imageInfoPanel, 1, wxEXPAND | wxALL, 5 );
	...
	m_panel2->SetSizer( panelSizer );
	m_panel2->Layout();
	panelSizer->Fit( m_panel2 );
	...
	// Connect Events
	imagesList->Connect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( Nin10KitGUI::OnImageDeselected ), NULL, this );
...
{
	// Disconnect Events
	imagesList->Disconnect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( Nin10KitGUI::OnImageDeselected ), NULL, this );
